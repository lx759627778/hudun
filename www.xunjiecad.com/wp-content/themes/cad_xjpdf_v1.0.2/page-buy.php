...
<main class="site-main buy-main content">
			...
			<ul class="product-info clearfix">
				<li class="col-1">
					<div class="product-pic">
                        <img src="<?php mySrc();?>/assets/images/product-pic-01.png">
                        <img src="<?php mySrc();?>/assets/images/product-pic-02.png" class="current">
						<img src="<?php mySrc();?>/assets/images/product-pic-03.png">
					</div>
				</li>
				<li class="col-2">
					<div class="product-cxt">
                        <h3 class="product-name" value="xunjiecadeditor">迅捷CAD编辑器【标准版】</h3>
						<div class="plan-cxt">
                            <p class="plan-detail">迅捷CAD编辑器(标准版)永久授权</p>
                            <p class="plan-detail current">迅捷CAD编辑器(标准版)永久授权 + 迅捷CAD转换器一年会员</p>
							<p class="plan-detail">迅捷CAD编辑器(标准版)永久授权 + 迅捷CAD转换器永久会员</p>
						</div>
                        <p class="product-price"><span class="smaller">￥</span><b class="price">128.00</b></p>
					</div>
                    <div class="product-type">
                        <h4 class="tips-title">版本类型：</h4>
                        <a href="/buy.html" class="current">标准版</a>
                        <a href="/buy-majors.html">专业版</a>
                    </div>
					<div class="product-plans">
						...
						<div class="plan-tips">
                            ...
                            <a href="javascript:void(0);"  value="vip156m120m120" data-price="156.00">156元超值套餐</a>                  
                        </div>
					</div>
				</li>
			</ul>
...
<div class="good-details">
    ...
    <div class="good-price">
        <a href="<?php myDownloadLinkStandard(); ?>" class="down-btn">立即下载</a>
        <div class="container">
            <p class="price-txt">迅捷CAD编辑器标准版是一款功能强大的专门应用于图纸DWG格式文件的编辑软件，主要为DWG、DXF等文件格式图纸提供浏览、编辑功能。使用迅捷CAD编辑器不但支持多种图纸格式的浏览，还全面支持图纸编辑功能，功能完全超越同类图纸编辑工具。</p>
            <ul class="clearfix">
                <li class="icon-box">
                    <div>
                        <img src="<?php mySrc(); ?>/assets/images/logo-5.png" alt="" />
                    </div>
                    <p>永久授权</p>
                </li>
                <li class="add-box">
                ...
                <li class="icon-box">
                    <div>
                        <img src="<?php mySrc(); ?>/assets/images/logo-6.png" alt="" />
                    </div>
                    <p>一年授权</p>
                </li>
                <li class="add-box">
    ...
    <div class="standard-tips-pic">
        <img src="<?php mySrc(); ?>/assets/images/standard-pic-02.png" alt="" />
    </div>
    <div class="shopping-tips">
        <h3>购<br />买<br />须<br />知</h3>
        <div class="shopping-txt">
            <p>1. 免费试用版软件仅可编辑2M以内的CAD文件，用户购买软件后，即可无限制使用该软件编辑文件功能。</p>
            <p>2. 用户需填写正确的手机号码，未注册用户会以该手机号自动注册账户并开通VIP功能；已注册用户会在该手机账户上开通VIP权限;</p>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ajustPlanIntroHeight = function(){
            $('.plan-details-text > li').css({
                'height': 'auto'
            });
            $('.plan-details-text > li').css({
                'height': $('.plan-details-text').outerHeight() +'px'
            });
        };
