<?php
/**
 * Template name: Page Help Majors
 */
get_header();
$page1 =3;
$showposts1 =9;
	...
	<section class="content clearfix">
        <div class="main-content">
            ...
            <div class="post-type-title clearfix">
                <a href="/help.html">迅捷CAD编辑器【标准版】</a>
                <a href="/help-majors.html" class="current">迅捷CAD编辑器【专业版】</a>
            </div>
            <div class="l-content">
                <ul class="cat-list help" id="itemContainer">
                    <?php
                        ...
                        query_posts($limit . '&paged=' . $paged .'&category_name=majors'.'&showposts='.$showposts1);
                ...
                <p class="post-count post-counts"><?php echo get_category_by_slug('majors')->count; ?></p>
                <div class="M-box"></div>
            </div>
        </div>
