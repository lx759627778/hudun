...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s designed by %2$s.', 'storefront' ), 'Storefront', '<a href="" title="WooCommerce - The Best eCommerce Platform for WordPress" rel="author">Vianrouge</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
...
if ( ! function_exists( 'storefront_site_branding' ) ) {
	...
	function storefront_site_branding() {
		...
		<div class="site-branding">
			...
			<a href="/">
				<img src="<?php mySrc();?>/assets/images/logo_02.jpg" alt="">
				<h2><strong><?php echo __('','storfront');?></strong></h2>
			</a>
		</div>
		<?php
	}
...
if ( ! function_exists( 'storefront_primary_navigation' ) ) {
	...
	function storefront_primary_navigation() {
		...
		<!-- <div class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><span><?php echo esc_attr( apply_filters( 'storefront_menu_toggle_text', __( 'Menu', 'storefront' ) ) ); ?></span></div> -->
			<?php
			wp_nav_menu(
				array(
...
if ( ! function_exists( 'storefront_paging_nav' ) ) {
	...
	function storefront_paging_nav() {
		...
		$args = array(
			'type' 	    => 'list',
			'next_text' => _x( '下一页', '下一篇文章', 'storefront' ),
			'prev_text' => _x( '上一页', '前一篇文章', 'storefront' ),
			);
