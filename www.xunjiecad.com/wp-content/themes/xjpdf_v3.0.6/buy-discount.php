...
$defaultPriceInt = '88';
?>
<section class="banner banner-buy-discount">
</section>
        ...
        <div class="wrapper buy">
            ...
            <dl class="goods">
                <dd class="goods-pics">
                    ...
                    <div class="goods-pic goods-pic-6 current"></div>
                </dd>
                <dd class="goods-infor">
                    <div class="plan-titles">
                        <h1 class="plan-title">迅捷PDF转换器 28元套餐</h1>
                    ...
                    <div class="plan-title-tips">
                        <p class="slogan">28元半年授权</p>
                        <p class="slogan">88元一年授权</p>
                        <p class="slogan">118元永久授权 + 迅捷PDF在线转换三年授权</p>
                        <p class="slogan current">88元永久授权 + 迅捷PDF编辑器永久授权 + 迅捷PDF在线转换三年授权(推荐)</p>
                    </div>
                    ...
                    <div class="plans">
                        ...
                        <div class="plan xjpdf-plans">
                            <a value="vip28m6" data-type="1" data-price="28">
                                <span>28元/1台电脑半年授权 </span>
                                <em class="active-icon"></em>
                            </a>
                            <!-- <a value="vip88m12" data-type="2">
                                <span>88元/1台电脑1年授权</span>
                                <em class="active-icon"></em>
                            </a>
                            <a value="vip118m120m36" data-type="3">
                                <span>118元超值套餐组合</span>
                                <em class="active-icon"></em>
                            </a> -->
                            <a class="current" value="vip88m120m120m36" data-type="4" data-price="88">
                                <span>88元黄金套餐组合</span>
                                <em class="active-icon"></em>
            ...
            <ul class="user-infor">
                ...
                <dl class="buy-input">
                    ...
                    <dd class="dd-02"><input type="text" value="" placeholder="请输入姓名" class="name" /></dd>
...
<div class="wechat-pay-dialog" id="show">
    ...
    <ul>
        ...
        <li class="li-02">
            <h3>微信扫码支付</h3>
            <h1 class="price-wechat"><?php echo $defaultPrice ?></h1>
            <div class="qr-code-wrapper" id="qrcode">
                <iframe  class="qr-code" id="qr-code" frameborder="0" scrolling="no"  src="">
                </iframe>
            </div>
            <div class="tips">
...
<section>
    <ul class="wrapper module">
        ...
        <li class="right">
            <div>
                <h1>相关说明</h1>
                <p>1、28.00元提供1台电脑1年授权，88.00元提供3台电脑永久授权。授权期间免费升级，重装系统仍可用。</p><hr>
