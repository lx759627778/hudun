            ...
            <div class="line-buy-center w1200">
                ...
                <div class="line-buy-ctt">
                    <div class="Setmeal-table clearfix">
                        <div class="Setmeal-table-th setmeal-th column-6">
                        ...
                        <div class="Setmeal-table-tr column-6">
                            <i class="hot-setmeal"></i>
                            <div class="Setmeal-table-td td-bg">
                                <p class=" font-24"><span class="icon-Set1">128VIP</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                        ...
                        <div class="Setmeal-table-tr column-6">
                            <div class="Setmeal-table-td td-bg">
                                <p class="font-24"><span class="icon-Set2">118VIP</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                                <p class="cl-blue">终身</p>
                            </div>
                            <div class="Setmeal-table-td td-bg">
                                <p>¥<span class="font-26">118</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                                <p>不限</p>
                            </div>
                        ...
                        <div class="Setmeal-table-tr column-6">
                            <div class="Setmeal-table-td td-bg">
                                <p class="font-24"><span class="icon-Set3">88VIP</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                                <p class="cl-blue">终身</p>
                            </div>
                         ...
                         <div class="Setmeal-table-tr column-6">
                            <div class="Setmeal-table-td td-bg">
                                <p class="font-24"><span class="icon-Set4">68VIP</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                            ...
                            <div class="Setmeal-table-td height-td">
                                <div class="Setmeal-inline">
                                    <p class="Setmeal-lg icon-lg2">迅捷PDF转换器<br/>【一年授权】</p>
                                </div>
                            </div>
                        </div>
                        <div class="Setmeal-table-tr column-6">
                            <div class="Setmeal-table-td td-bg">
                                <p class="font-24"><span class="icon-Set5">48VIP</span></p>
                            </div>
                            <div class="Setmeal-table-td">
                            ...
                            <div class="Setmeal-table-td height-td">
                                <div class="Setmeal-inline">
                                    <p class="Setmeal-lg icon-lg2">迅捷PDF转换器<br/>【半年授权】</p>
                                </div>
                            </div>
                        </div>
                    </div>
