...
get_header();
?>
    <link rel="stylesheet" type="text/css" href="<?php echo mySrc();?>/css/converter.css">
    <main class="main-ctt">
        <section class="converter-banner">
            <div class="converter-banner-center w1200 row">
                <div class="converter-banner-text col-6">
                    <img src="<?php echo mySrc();?>/images/converter/banner-h.png" alt="">
                    ...
                    <div class="converter-btn-link">
                        <a href="" class="dwon-link"></a>
                        <a href="" class="buy-link"><span>购买</span></a>
                    </div>
                </div>
        ...
        <section class="line-Product">
            <div class="line-Product-center w1200">
                <h6>产品介绍</h6>
                <p>捷PDF转换器是一款功能强大、界面简洁、操作简单的PDF与WORD、EXCEL、 PPT等多种格式互相任意转换的软件。</p>
                <ul class="converter-Product-list clearfix">
                    <li>
                        <img src="<?php echo mySrc();?>/images/converter/icon-js1.png" alt="">
                    ...
                    <li>
                        <img src="<?php echo mySrc();?>/images/converter/icon-js2.png" alt="">
                        <div class="converter-Product-text">
                            <h6>转换快速质量保障</h6>
                    ...
                    <li>
                        <img src="<?php echo mySrc();?>/images/converter/icon-js3.png" alt="">
                        <div class="converter-Product-text">
                            <h6>界面清晰体验舒心</h6>
                    ...
                    <li class="no-mr">
                        <img src="<?php echo mySrc();?>/images/converter/icon-js4.png" alt="">
                        <div class="converter-Product-text">
                            <h6>轻松拖拽批量转换</h6>
                ...
                <div class="line-converter-ctt">
                    ...
                    <div class="converter-function-list">
                        <div class="converter-function-li">
                            ...
                            <div class="converter-function-link clearfix">
                                <a href="" class="bd-cl1">PDF页面提取<i></i></a>
                                <a href="" class="bd-cl2">PDF加密<i></i></a>
                                <a href="">PDF分割</a>
                                <a href="">PDF合并</a>
                                <a href="">PDF图片提取</a>
                                <a href="">PDF压缩</a>
