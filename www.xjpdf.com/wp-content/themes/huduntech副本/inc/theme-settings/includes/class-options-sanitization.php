...
function of_recognized_background_repeat()
{
    $default = array(
        ...
        'repeat-x' => __('Repeat Horizontally', 'text_domain'),
        'repeat-y' => __('Repeat Vertically', 'text_domain'),
        'repeat' => __('Repeat All', 'text_domain'),
    );
...
{
    $default = array(
        'scroll' => __('Scroll Normally', 'text_domain'),
        'fixed' => __('Fixed in Place', 'text_domain'),
    );
...
function of_recognized_font_styles()
{
    $default = array(
        ...
        'italic' => __('Italic', 'text_domain'),
        'bold' => __('Bold', 'text_domain'),
        'bold italic' => __('Bold Italic', 'text_domain'),
    );
